...
double pgain(long x, Points *points, double z, long int *numcenters, int pid, pthread_barrier_t* barrier)
{
  ...
  if( pid==0 )    { 
    ...
    //AMHM Starts
    m5_add_approx(  (uint32_t)&work_mem, (uint32_t)(&work_mem + (stride*(nproc+1)*sizeof(double)) - 1), reliability_level);
    //AMHM Ends
  ...
  */
  ...
  //AMHM Starts
  m5_add_approx(  (uint32_t)&switch_membership, (uint32_t)(&switch_membership + ((k2-k1)*sizeof(bool)) - 1), reliability_level);
  //AMHM Ends
  ...
  if( pid == 0 ) {
    free(work_mem);
    //AMHM Starts
    m5_remove_approx(  (uint32_t)&work_mem, (uint32_t)(&work_mem + (stride*(nproc+1)*sizeof(double)) - 1), reliability_level);
    //AMHM Ends
    //    free(is_center);
...
int selectfeasible_fast(Points *points, int **feasible, int kmin, int pid, pthread_barrier_t* barrier)
{
  ...
  *feasible = (int *)malloc(numfeasible*sizeof(int));
  //AMHM Starts
  m5_add_approx(  (uint32_t)&feasible, (uint32_t)(&feasible + (numfeasible*sizeof(int) - 1)), reliability_level);
  //AMHM Ends  
  ...
  //AMHM Starts
  m5_add_approx(  (uint32_t)&accumweight, (uint32_t)(&accumweight + (sizeof(float)*points->num - 1)), reliability_level);
  //AMHM Ends  
  ...
  free(accumweight); 
  //AMHM Starts
  m5_remove_approx(  (uint32_t)&accumweight, (uint32_t)(&accumweight + (sizeof(float)*points->num - 1)), reliability_level);
  //AMHM Ends  
	       ...
	       int pid, pthread_barrier_t* barrier )
{
  ...
  if( pid==0 )
  {
    ...
    //AMHM Starts
    m5_add_approx(  (uint32_t)&hizs, (uint32_t)(&hizs + (nproc*sizeof(double) - 1)), reliability_level);
    //AMHM Ends
  }
  hiz = loz = 0.0;
...
void copycenters(Points *points, Points* centers, long* centerIDs, long offset)
{
  ...
  //AMHM Starts
  m5_add_approx(  (uint32_t)&is_a_median, (uint32_t)(&is_a_median + (points->num*sizeof(bool) - 1)), reliability_level);
  //AMHM Ends
		    ...
		    long chunksize, long centersize, char* outfile )
{
  ...
  //AMHM Starts
  m5_add_approx(  (uint32_t)&block, (uint32_t)(&block + (chunksize*dim*sizeof(float) - 1)), reliability_level);
  //AMHM Ends
  float* centerBlock = (float*)malloc(centersize*dim*sizeof(float) );
  //AMHM Starts
  m5_add_approx(  (uint32_t)&centerBlock, (uint32_t)(&centerBlock + (centersize*dim*sizeof(float) - 1)), reliability_level);
  //AMHM Ends
  ...
  while(1) {
    ...
    //AMHM Starts
    m5_add_approx(  (uint32_t)&switch_membership, (uint32_t)(&switch_membership + (points.num*sizeof(bool) - 1)), reliability_level);
    //AMHM Ends
    is_center = (bool*)calloc(points.num,sizeof(bool));
    //AMHM Starts
    m5_add_approx(  (uint32_t)&is_center, (uint32_t)(&is_center + (points.num*sizeof(bool) - 1)), reliability_level);
    //AMHM Ends
    center_table = (int*)malloc(points.num*sizeof(int));
    //AMHM Starts
    m5_add_approx(  (uint32_t)&center_table, (uint32_t)(&center_table + (points.num*sizeof(int) - 1)), reliability_level);
    //AMHM Ends
    ...
    free(is_center);
    //AMHM Starts
    m5_remove_approx(  (uint32_t)&is_center, (uint32_t)(&is_center + (points.num*sizeof(bool) - 1)), reliability_level);
    //AMHM Ends
    free(switch_membership);
    //AMHM Starts
    m5_remove_approx(  (uint32_t)&switch_membership, (uint32_t)(&switch_membership + (points.num*sizeof(bool) - 1)), reliability_level);
    //AMHM Ends
    free(center_table);
    //AMHM Starts
    m5_add_approx(  (uint32_t)&center_table, (uint32_t)(&center_table + (points.num*sizeof(int) - 1)), reliability_level);
  ...
  //AMHM Starts
  m5_add_approx(  (uint32_t)&switch_membership, (uint32_t)(&switch_membership + (centers.num*sizeof(bool) - 1)), reliability_level);
  //AMHM Ends
  is_center = (bool*)calloc(centers.num,sizeof(bool));
  //AMHM Starts
  m5_add_approx(  (uint32_t)&is_center, (uint32_t)(&is_center + (centers.num,sizeof(bool) - 1)), reliability_level);
  //AMHM Ends
  center_table = (int*)malloc(centers.num*sizeof(int));
  //AMHM Starts
  m5_add_approx(  (uint32_t)&center_table, (uint32_t)(&center_table + (centers.num*sizeof(int) - 1)), reliability_level);
  //AMHM Ends
...
#define __PARSEC_XSTRING(x) __PARSEC_STRING(x)
  ...
  if (argc<11) {
    ...
    fprintf(stderr,"  r:           Reliability level to use\n");
    fprintf(stderr,"\n");
  ...
  nproc = atoi(argv[9]);
  //AMHM Starts
  reliability_level = atoi(argv[10]);
  //AMHM Ends
